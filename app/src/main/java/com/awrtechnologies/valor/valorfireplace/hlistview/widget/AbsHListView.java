package com.awrtechnologies.valor.valorfireplace.hlistview.widget;
...
import com.awrtechnologies.valor.valorfireplace.hlistview.util.ViewHelperFactory;
import com.awrtechnologies.valor.valorfireplace.hlistview.util.ViewHelperFactory.ViewHelper;
import com.awrtechnologies.valor.valorfireplace.hlistview.util.v11.MultiChoiceModeListener;
import com.awrtechnologies.valor.valorfireplace.hlistview.util.v11.MultiChoiceModeWrapper;
...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
	...
	/**
	 * Fires an "on scroll state changed" event to the registered {@link com.needapps.hlistview.widget.AbsHListView.OnScrollListener}, if any.
	...
	private class FlingRunnable implements Runnable {
		 ...
		 */
		private final com.awrtechnologies.valor.valorfireplace.hlistview.widget.OverScroller mScroller;
	 ...
	 *
	 * @see com.needapps.hlistview.widget.AbsHListView.RecycleBin
	 * @see com.needapps.hlistview.widget.AbsHListView.RecyclerListener
	 */
	 ...
	 *
	 * @see com.needapps.hlistview.widget.AbsHListView.RecycleBin
	 * @see com.needapps.hlistview.widget.AbsHListView#setRecyclerListener(com.needapps.hlistview.widget.AbsHListView.RecyclerListener)
	 */
